...
const Footer = () => {
  return (
    <footer className='border-t border-light-gray mt-[130px]'>
      <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 py-12">
            <div className="flex flex-col items-center justify-center">
                <div>
                    <h2 className='text-2xl text-dark-gray font-semibold'>Make My Trip</h2>
                </div>
                <div className="space-y-3 text-center md:space-y-0 md:flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
                    <p className="hover:text-dark-gray text-lg cursor-pointer leading-4 text-light-gray">About</p>
                    <p className="hover:text-dark-gray text-lg cursor-pointer leading-4 text-light-gray">Contact us</p>
                    <p className="hover:text-dark-gray text-lg cursor-pointer leading-4 text-light-gray">Terms of Service</p>
                    <p className="hover:text-dark-gray text-lg cursor-pointer leading-4 text-light-gray">Privacy Policy</p>
                </div>
                <div className="flex items-center gap-x-8 mt-6">
                    <div className="cursor-pointer">
                        <svg className="fill-current text-light-gray hover:text-dark-gray" width="27" height="27" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="cursor-pointer">
                        <svg className="fill-current text-light-gray hover:text-dark-gray" width="27" height="27" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="cursor-pointer">
                        <svg className="fill-current text-light-gray hover:text-dark-gray" width="27" height="27" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div className="flex items-center mt-6">
                    <p className="text-base leading-4 text-light-gray">
                        2021 <span className="font-semibold">Make My Trip</span>
                    </p>
                    <div className="border-l border-gray-800 pl-2 ml-2">
                        <p className="text-base leading-4 text-light-gray">Inc. All righys reserved</p>
                    </div>
                </div>
            </div>
        </div>
